...
public class Sorting {
    ...
    public static <T extends Comparable<? super T>> SortAlgorithm<T> heap() {
        return new HeapSortAlgorithm<>();
    }

    public static IntSortAlgorithm heapInt() {
        return new IntHeapSortAlgorithm();
    }

    public static LongSortAlgorithm heapLong() {
        return new LongHeapSortAlgorithm();
    }

    public static DoubleSortAlgorithm heapDouble() {
        return new DoubleHeapSortAlgorithm();
    }
}
